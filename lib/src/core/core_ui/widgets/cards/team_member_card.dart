// lib/src/core/core_ui/widgets/cards/team_member_card.dart

import 'package:flutter/material.dart';
import '../../theme/app_colors.dart';
import '../avatars/avatar_with_initials.dart';
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.email, size: 14, color: AppColors.iconColor),
            ...
            if (phone != null) ...[
              ...
              Row(
                children: [
                  Icon(Icons.phone, size: 14, color: AppColors.iconColor),
                  const SizedBox(width: 4),
                  Text(phone!),
                ],
              ),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          color: AppColors.lighten(roleColor, 0.85),
          child: Row(
            children: [
